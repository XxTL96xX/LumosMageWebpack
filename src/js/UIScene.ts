    ...
    create() {
        ...
        */
        ...
        try {
            ...
            console.log("emiting shop weapon")
        ...
        var item1Image = this.add.sprite(item1.x, item1.y, "baseBall");
        ...
        var item2Image = this.add.sprite(item2.x, item2.y, "baseBall");
        ...
        var item3Image = this.add.sprite(item3.x, item3.y, "baseBall");
        ...
        var item4Image = this.add.sprite(item4.x, item4.y, "baseBall");
